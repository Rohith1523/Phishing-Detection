...
if st.button("Check"):
    if not user_url:
        ...
        # Initialize the feature vector with the first two features
        feature_vector = [[length_url, length_hostname]]
        ...
        # For example:
        # feature3 = ...  # Extract and preprocess feature 3 from the URL
        # feature4 = ...  # Extract and preprocess feature 4 from the URL
        # feature_vector[0].extend([feature3, feature4, ...])
